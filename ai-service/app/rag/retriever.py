...
SEED_CATALOG = [
    # ==================== CLASSIC OXFORD SHIRTS (ALL COLOR VARIANTS) ====================
    {
        "id": "var_101",
        "product_id": "prod_oxford",
    ...
    },
    {
        ...
        "short_description": "Lightweight pastel pink linen oxford shirt for summer casual and party outings.",
    ...
    },
    {
        ...
        "short_description": "Relaxed fit beige cotton-linen oxford shirt. Great for brunch or weekend outings.",
    ...
    },
    {
        ...
        "short_description": "Crisp sky blue oxford shirt. Wrinkle-free Egyptian cotton for boardroom confidence.",
    ...
    },
    {
        ...
        "short_description": "Rugged olive green utility oxford shirt. Perfect for adventure and casual wear.",
    ...
    },
    {
        ...
        "short_description": "Bold maroon slim fit satin-touch party oxford shirt. Stand out at evening events.",
    ...
    },
    {
        ...
        "short_description": "Soft grey pattern cotton oxford shirt. Versatile for layering or standalone casual look.",
        "style_tags": ["Casual", "Layering", "Daily Wear", "Men"],
        "complementary_categories": ["Jeans", "Trousers", "Jackets"]
    },

    # ==================== ESSENTIAL T-SHIRTS (ALL COLOR VARIANTS) ====================
    {
        "id": "var_117",
        "product_id": "prod_tee",
        "name": "Essential Round Neck Cotton Tee",
        "category": "Men",
    ...
    },
    {
        ...
        "short_description": "Smart navy blue cotton tee. Bio-washed cotton for breathable comfort.",
    ...
    },
    {
        ...
        "short_description": "Retro grey cotton tee. Soft texture for daily casual streetwear vibes.",
    ...
    },
    {
        ...
        "short_description": "Olive green cotton tee. Soft slub cotton for a textured casual look.",
        "style_tags": ["Casual", "Layering", "Smart Casual", "Men"],
        "complementary_categories": ["Jeans", "Chinos", "Jackets"]
    },

    # ==================== CHINO TROUSERS (ALL COLOR VARIANTS) ====================
    {
        "id": "var_103",
        "product_id": "prod_chino",
    ...
    },
    {
        ...
        "short_description": "Sharp black flex-stretch formal chino trousers for a polished boardroom or casual look.",
        "style_tags": ["Formal", "Office", "Business", "Men"],
    ...
    },
    {
        ...
        "short_description": "Comfortable beige flex-stretch cotton chinos. All-day ease and classic styling.",
    ...
    },
    {
        ...
        "stock_qty": 14,
        "image_url": "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=500&auto=format&fit=crop",
        "short_description": "Modern grey tapered flex-stretch chinos. Versatile for office-to-dinner transitions.",
    ...
    },
    {
        ...
        "short_description": "Tactical olive green flex-stretch chinos. Durable twill cotton for outdoor and casual wear.",
