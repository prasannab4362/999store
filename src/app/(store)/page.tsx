    ...
    <div className="space-y-16 pb-12">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 rounded-promo bg-brand-primary-soft p-8 md:p-12 grid md:grid-cols-2 gap-8 items-center border border-brand-primary/10">
        ...
        <div className="relative aspect-video rounded-card overflow-hidden border border-border-light shadow-sm bg-white">
          <Image
            src={getPlaceholderSvg("Mix & Match Visual Guide", 600, 450, "ffffff", "6D28D9")}
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Men's landing card */}
          <div className="group relative rounded-promo overflow-hidden aspect-[16/10] border border-border-light shadow-sm bg-white">
            <Image
              src={getPlaceholderSvg("Men's Combo Fashion", 800, 500, "1D2A44", "ffffff")}
          ...
          <div className="group relative rounded-promo overflow-hidden aspect-[16/10] border border-border-light shadow-sm bg-white">
            <Image
              src={getPlaceholderSvg("Women's Combo Fashion", 800, 500, "B76E79", "ffffff")}
